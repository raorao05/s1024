...
class ZillaLikes {
	...
	function admin_menu() 
	{
		$icon_url = get_template_directory_uri() .'/lib/admin/zilla-likes/images/favicon.png';
	...
	function setting_disable_css()
	{
		...
		else $theme_name = get_current_theme(); // Fallback for older WordPress
	...
	function enqueue_scripts()
	{
		...
		//if(!$options['disable_css']) wp_enqueue_style( 'zilla-likes', get_template_directory_uri() .'/lib/admin/zilla-likes/styles/zilla-likes.css' );
		
		wp_enqueue_script( 'zilla-likes', get_template_directory_uri() . '/lib/admin/zilla-likes/scripts/zilla-likes.js', array('jquery') );
